...
// 익명함수 : 이름이 없는 함수로, 주로 변수에 할당하거나 다른 함수의 인수로 사용함.

const 함수명3 = function(매개변수1, 매개변수2)
{
    // 함수명3라는 상수에, 익명함수가 할당 되었음
 ...
 * 즉 {}생략 안하고 return 하려면 return 키워드를 명시해야 함.
 */
...
const 리턴값4 = 함수명;
// 함수를 호출한 게 아님, 함수명 자체를 리턴값4에 할당.
console.log(리턴값4()); // 함수명 함수 자체가 출력됨.

// 고차함수
const aa = () => {
    console.log("고차함수 aa 호출");
    return "aa함수 리턴값"
}

const bb = (fxx) => {
    console.log("고차함수 bb 호출");
    return fxx;
}

const aaa = (fxx, fxx2) => {
    console.log("고차함수 aaa 호출");
    console.log(fxx());
    console.log(fxx2());
    return "aaa함수 리턴값";
};
